...
#added 01.08.2012
###XSL0303
HeavyChromaticBeamGeneratorCollisionBeam = Class(SCCollisionBeam) {

    TerrainImpactType = 'LargeBeam01',
    TerrainImpactScale = 1,
    FxBeamStartPoint = EffectTemplate.SUltraChromaticBeamGeneratorMuzzle02,
    FxBeam = EffectTemplate.SUltraChromaticBeamGeneratorBeam02,
    FxBeamEndPoint = EffectTemplate.SUltraChromaticBeamGeneratorHitLand02,
    SplatTexture = 'czar_mark01_albedo',
    ScorchSplatDropTime = 0.25,
