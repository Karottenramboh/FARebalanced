...
#added 04.07.2012
SIFSmartCharge = Class(DefaultProjectileWeapon) {
    ...
    #    LOG('*INFO: AIFSmartCharge->AddDepthCharge')
        proj:AddDepthCharge(tbl)
    end,
}

#added 14.07.2012
SSamFlaresWeapon = Class(DefaultProjectileWeapon) {
    CreateProjectileAtMuzzle = function(self, muzzle)
        local proj = DefaultProjectileWeapon.CreateProjectileAtMuzzle(self, muzzle)
    #    if not proj or proj:BeenDestroyed() then
    #        return proj
...
#added 01.08.2012
SDFHeavyChromaticBeamGenerator = Class(DefaultBeamWeapon) {
    BeamType = CollisionBeamFile.HeavyChromaticBeamGeneratorCollisionBeam,
    FxMuzzleFlash = {},
    FxChargeMuzzleFlash = EffectTemplate.SChargeUltraChromaticBeamGenerator02,
    #FxUpackingChargeEffects = EffectTemplate.SChargeUltraChromaticBeamGenerator,
    #FxUpackingChargeEffectScale = 1,
