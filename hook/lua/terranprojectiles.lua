...
TAALightFragmentationProjectile = Class(SingleCompositeEmitterProjectile) {
    BeamName = '/Mods/FARebalanced/effects/emitters/antiair_munition_beam_01_emit.bp',
    PolyTrail = '/effects/emitters/default_polytrail_01_emit.bp',
    PolyTrailOffset = 0,
    FxTrails = {'/Mods/FARebalanced/effects/emitters/terran_flack_fxtrail_01_emit.bp'},
    FxImpactAirUnit = EffectTemplate.TFlakHit,
    FxImpactNone = EffectTemplate.TFlakHit,
    FxImpactUnderWater = {},
}
...
#added 06.07.2012
TCarpetBomb = Class(SinglePolyTrailProjectile) {
	FxImpactTrajectoryAligned = false,
    PolyTrail = '/effects/emitters/antimatter_polytrail_01_emit.bp',
    PolyTrailOffset = 0,

    # Hit Effects
    FxImpactUnit = EffectTemplate.TCarpetBombingHitLand,
    FxImpactProp = EffectTemplate.TCarpetBombingHitLand,
    FxImpactLand = EffectTemplate.TCarpetBombingHitLand,
    FxImpactWater = EffectTemplate.TCarpetBombingHitWater,   
    FxLandHitScale = 1,
    FxImpactUnderWater = {},
    FxSplatScale = 8,
}

TSamFlareProjectile = Class(SinglePolyTrailProjectile) {
    ...
    PolyTrail = '/effects/emitters/antimatter_polytrail_01_emit.bp',
    FxTrails = EffectTemplate.TFlares01,
    FxImpactProjectile = {},
...
TLaserShellPhalanxProjectile = Class(SinglePolyTrailProjectile) {
    PolyTrail = '/Mods/FARebalanced/effects/emitters/phalanx_laser_munition_polytrail_01_emit.bp',
    FxImpactUnit = EffectTemplate.TRiotGunHitUnit01,
    FxImpactProp = EffectTemplate.TRiotGunHitUnit01,
    FxImpactNone = EffectTemplate.FireCloudSml01,
    FxImpactLand = EffectTemplate.TRiotGunHit01,
