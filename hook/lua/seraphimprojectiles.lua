...
SHeavyQuarnonCannon = Class(MultiPolyTrailProjectile) {
    ...
    FxImpactNone = EffectTemplate.SZhanaseeBombHit01,
...
#---SDepthCharge added 03.07.2012
SDepthChargeProjectile = Class(MultiPolyTrailProjectile) {
...
SSamFlareProjectile = Class(SinglePolyTrailProjectile) {
    ...
    FxTrails =				EffectTemplate.SFlares01,
    PolyTrail =				EffectTemplate.SOtheBombPolyTrail,
    FxImpactProjectile = {},
...
SNewZhanaseeBombProjectile = Class(EmitterProjectile) {
    FxImpactTrajectoryAligned = false,
    
    FxTrails = EffectTemplate.SNewZhanaseeBombFxTrails01,
	  FxImpactUnit = EffectTemplate.SZhanaseeBombHit01,
    FxImpactProp = EffectTemplate.SZhanaseeBombHit01,
    FxImpactAirUnit = EffectTemplate.SZhanaseeBombHit01,
    FxImpactLand = EffectTemplate.SZhanaseeBombHit01,
...
SSmartBombProjectile = Class(EmitterProjectile) {
    FxTrails = EffectTemplate.SSmartBombFxTrails01,

    FxImpactUnit = EffectTemplate.SSmartBombHit,
    FxImpactProp = EffectTemplate.SSmartBombHit,
    FxImpactNone = EffectTemplate.SSmartBombHit,
    FxImpactLand = EffectTemplate.SSmartBombHit,
    FxImpactUnderWater = {},
}