...
Shield = Class(moho.shield_methods,Entity) {
    ...
    OnCreate = function(self,spec)
		...
		local loccantakedamage
		if spec.CanTakeDamage == nil then
			loccantakedamage = true
		else
			loccantakedamage = spec.CanTakeDamage
		end
