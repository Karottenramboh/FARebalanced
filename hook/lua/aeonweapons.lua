...
#added 12.07.2012
AAASamFlaresWeapon = Class(DefaultProjectileWeapon) {
    CreateProjectileAtMuzzle = function(self, muzzle)
        local proj = DefaultProjectileWeapon.CreateProjectileAtMuzzle(self, muzzle)
    #    if not proj or proj:BeenDestroyed() then
    #        return proj
...
#added 24.07.2012
ABSZapplaserWeapon = Class(DefaultProjectileWeapon) {
    FxMuzzleFlash = {
        '/Mods/FARebalanced/effects/emitters/zapplaser_muzzle_01_emit.bp',
        '/Mods/FARebalanced/effects/emitters/zapplaser_muzzle_02_emit.bp',
    },
}
