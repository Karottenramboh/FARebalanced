        ...
        elseif atype == 'Damage' then
            ...
            for i = 1, unit:GetWeaponCount() do
                ...
                if wep.Label != 'DeathWeapon' and wep.Label != 'DeathImpact' then
                    ...
                    #LOG('*BUFF: Unit ', repr(unit:GetEntityId()), ' buffed damage from ', wepdam, ' to ', val)
                end
            end
...
function BuffCalculate(unit, buffName, affectType, initialVal, initialBool)
    ...
    #LOG('*INFO: InitalVal: ' .. initialVal .. ', Adds: ' .. adds .. ', Multis: ' .. mults .. ', Return: ' .. returnVal)
    ...
    #LOG('*INFO: RealReturnVal: ' .. returnVal)
