...
ADepthChargeProjectile = Class(OnWaterEntryEmitterProjectile) {
    ...
    FxImpactProjectile = EffectTemplate.ADepthChargeHitUnderWaterUnit01,
    FxImpactNone = {},
...
ATemporalFizzAAProjectile = Class(SingleCompositeEmitterProjectile) {
    BeamName = '/Mods/FARebalanced/effects/emitters/temporal_fizz_munition_beam_01_emit.bp',
    FxTrails = {
    '/Mods/FARebalanced/effects/emitters/temporal_fizz_fxtrail_01_emit.bp',
    '/Mods/FARebalanced/effects/emitters/temporal_fizz_fxtrail_02_emit.bp',},
    PolyTrail = '/effects/emitters/default_polytrail_03_emit.bp',
    FxImpactUnit = EffectTemplate.ATemporalFizzHit02,
    FxImpactAirUnit = EffectTemplate.ATemporalFizzHit02,
    FxImpactNone = EffectTemplate.ATemporalFizzHit02,
}
...
###FAR Projectiles
SDepthChargeProjectile = Class(OnWaterEntryEmitterProjectile) {
...
AQuarkBombProjectile2 = Class(EmitterProjectile) {
    FxTrails = EffectTemplate.AQuarkBomb03,
    FxTrailScale = 1,

# Hit Effects
    FxImpactUnit = EffectTemplate.AQuarkBomb03Hit,
    FxImpactProp = EffectTemplate.AQuarkBomb03Hit,
    FxImpactAirUnit = EffectTemplate.AQuarkBomb03Hit,
    FxImpactLand = EffectTemplate.AQuarkBomb03Hit,
    FxImpactUnderWater = {},
}
ASamFlareProjectile = Class(SinglePolyTrailProjectile) {
...
AZappLaserProjectile = Class(MultiPolyTrailProjectile) {

    PolyTrails = {
		'/Mods/FARebalanced/effects/emitters/zapplaser_polytrail_01_emit.bp',
	  },
    FxTrails = EffectTemplate.ZappLaser01,
