...
CAAElectronBurstCloudProjectile = Class(SinglePolyTrailProjectile) {
    ...
    FxTrails = {'/Mods/FARebalanced/effects/emitters/cybran_electronic_burst_fxtrail_01_emit.bp',},  
    # Hit Effects
    FxImpactLand = {},
    FxImpactWater = {},
    FxImpactUnderWater = {},
    FxImpactAirUnit = EffectTemplate.CElectronBurstCloud02,
    FxImpactNone = EffectTemplate.CElectronBurstCloud02,
}
...
CLaserLaserProjectile = Class(MultiPolyTrailProjectile) {
    PolyTrails = {
        '/Mods/FARebalanced/effects/emitters/cybran_laser_trail_03_emit.bp',
...
CHeavyLaserProjectile = Class(MultiPolyTrailProjectile) {
    PolyTrails = {
        '/Mods/FARebalanced/effects/emitters/cybran_laser_trail_04_emit.bp',
		#'/effects/emitters/default_polytrail_03_emit.bp',
	},
	PolyTrailOffset = {0,0}, 
...
#added 11.07.2012
CIFProtonBombProjectile2 = Class(SinglePolyTrailProjectile) {
	FxImpactTrajectoryAligned = false,
    PolyTrail = '/Mods/FARebalanced/effects/emitters/protonbomb_polytrail_01_emit.bp',
    PolyTrailOffset = 0,

    # Hit Effects
    FxImpactUnit = EffectTemplate.CProtonCarpetBombingHitLand,
    FxImpactProp = EffectTemplate.CProtonCarpetBombingHitLand,
    FxImpactLand = EffectTemplate.CProtonCarpetBombingHitLand,
    FxImpactWater = EffectTemplate.CProtonBombHit01,   
    FxLandHitScale = 1,
    FxImpactUnderWater = {},
    FxSplatScale = 8,
}
#added 14.07.2012
CSamFlareProjectile = Class(MultiPolyTrailProjectile) {
    ...
    PolyTrails = {
      ...
      FxTrails = {
        ...
        '/Mods/FARebalanced/effects/emitters/c_flares_01_emit.bp',
        '/Mods/FARebalanced/effects/emitters/c_flares_02_emit.bp',},
      FxImpactProjectile = {},
    ...
    AddSamFlares = function(self, tbl)
        if not tbl then return end
        if not tbl.Radius then return end
        self.MySamFlares = SamFlares {
            Owner = self,
            Radius = tbl.Radius or 10,
        }
        self.Trash:Add(self.MySamFlares)
    end,
}
CDFProtonCannonProjectile02 = Class(SinglePolyTrailProjectile) {
    PolyTrail = '/Mods/FARebalanced/effects/emitters/proton_cannon_polytrail_03_emit.bp',

    FxTrails = EffectTemplate.CProtonCannonFXTrail03,
    FxImpactUnit = EffectTemplate.CProtonCannonHit02,
    FxImpactProp = EffectTemplate.CProtonCannonHit02,
    FxImpactLand = EffectTemplate.CProtonCannonHit02,
    FxTrailOffset = 0,
    FxImpactUnderWater = {},
}