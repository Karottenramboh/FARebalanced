...
#added 08.07.2012
ModEmtBpPath = '/Mods/FARebalanced/effects/emitters/'
...
###------------------------FAREBALANCED EFFECTS--------------------
AQuarkBomb03 = {
    ModEmtBpPath .. 'quark_bomb_01_emit.bp', #main sparkle
    ModEmtBpPath .. 'quark_bomb_02_emit.bp', #light
    ModEmtBpPath .. 'quark_bomb_03_emit.bp', #green smoke
    ModEmtBpPath .. 'quark_bomb_04_emit.bp', #green ring
}
AQuarkBomb03Hit = {
    ModEmtBpPath .. 'quark_bomb_hit_01_emit.bp', #flash
    ModEmtBpPath .. 'quark_bomb_hit_02_emit.bp', #ground lightning
    ModEmtBpPath .. 'quark_bomb_hit_03_emit.bp', #initial ring
    ModEmtBpPath .. 'quark_bomb_hit_04_emit.bp', #pulse rings
    ModEmtBpPath .. 'quark_bomb_hit_05_emit.bp', #outer smoke
    ModEmtBpPath .. 'quark_bomb_hit_06_emit.bp', #inner smoke
    ModEmtBpPath .. 'quark_bomb_hit_07_emit.bp', #wobble
}
TCarpetBombingHitLand = {
    ModEmtBpPath .. 'carpetbomb_hit_01_emit.bp',  #flash
    ModEmtBpPath .. 'carpetbomb_hit_02_emit.bp',  #glow
    ModEmtBpPath .. 'carpetbomb_hit_03_emit.bp',  #sparks
    ModEmtBpPath .. 'carpetbomb_hit_04_emit.bp',  #fire1
    ModEmtBpPath .. 'carpetbomb_hit_05_emit.bp',  #fire2
    ModEmtBpPath .. 'carpetbomb_hit_06_emit.bp',  #fire-smoke
    ModEmtBpPath .. 'carpetbomb_hit_07_emit.bp',  #smoke
    ModEmtBpPath .. 'carpetbomb_hit_08_emit.bp',  #ring
}
TCarpetBombingHitWater = {
    ModEmtBpPath .. 'carpetbomb_hit_water_01_emit.bp',  #ground
    ModEmtBpPath .. 'carpetbomb_hit_water_02_emit.bp',  #ground
    ModEmtBpPath .. 'carpetbomb_hit_water_03_emit.bp',  #water wush
    ModEmtBpPath .. 'carpetbomb_hit_water_04_emit.bp',  #water wush2
}
CProtonCarpetBombingHitLand = {
    ModEmtBpPath .. 'protoncarpetbomb_hit_01_emit.bp',  #flash
    ModEmtBpPath .. 'protoncarpetbomb_hit_02_emit.bp',  #red ring shrinking
    ModEmtBpPath .. 'protoncarpetbomb_hit_03_emit.bp',  #main ring
    ModEmtBpPath .. 'protoncarpetbomb_hit_04_emit.bp',  #remaining rust glow
    ModEmtBpPath .. 'protoncarpetbomb_hit_05_emit.bp',  #another ring
    ModEmtBpPath .. 'protoncarpetbomb_hit_06_emit.bp',  #plasma in remaining cloud
    ModEmtBpPath .. 'protoncarpetbomb_hit_07_emit.bp',  #air ring
    ModEmtBpPath .. 'protoncarpetbomb_hit_08_emit.bp',  #many rings...
    ModEmtBpPath .. 'protoncarpetbomb_hit_09_emit.bp',  #electricity
    ModEmtBpPath .. 'protoncarpetbomb_hit_10_emit.bp',  #smoke
}

TFlares01 = {
    ModEmtBpPath .. 'quark_bomb_01_emit.bp', #main sparkle
    ModEmtBpPath .. 't_flares_01_emit.bp',
    ModEmtBpPath .. 't_flares_02_emit.bp',
    ModEmtBpPath .. 't_flares_03_emit.bp',
}

SFlares01 = {
  	ModEmtBpPath .. 's_flares_01_emit.bp',
    ModEmtBpPath .. 's_flares_02_emit.bp',
    ModEmtBpPath .. 's_flares_03_emit.bp',
}

SNewZhanaseeBombFxTrails01 = {
    ModEmtBpPath .. 's_zhanasee_fxtrails_01_emit.bp',
    ModEmtBpPath .. 's_zhanasee_fxtrails_02_emit.bp',
    #ModEmtBpPath .. 's_zhanasee_fxtrails_03_emit.bp',
    #ModEmtBpPath .. 's_zhanasee_fxtrails_04_emit.bp',
}
SNewZhanaseeBombSplit = {
    ModEmtBpPath .. 's_zhanasee_split_01_emit.bp',
    ModEmtBpPath .. 's_zhanasee_split_02_emit.bp',
    ModEmtBpPath .. 's_zhanasee_split_03_emit.bp',
    ModEmtBpPath .. 's_zhanasee_split_04_emit.bp',
}
SSmartBombFxTrails01 = {
    ModEmtBpPath .. 's_smartbomb_fxtrails_01_emit.bp',
    ModEmtBpPath .. 's_smartbomb_fxtrails_02_emit.bp',
}
SSmartBombHit = {
    ModEmtBpPath .. 'seraphim_sih_projectile_01_emit.bp',
    ModEmtBpPath .. 'seraphim_sih_projectile_02_emit.bp',
    ModEmtBpPath .. 'seraphim_sih_projectile_03_emit.bp',
    ModEmtBpPath .. 'seraphim_sih_projectile_04_emit.bp',
    ModEmtBpPath .. 'seraphim_sih_projectile_05_emit.bp',
    ModEmtBpPath .. 'seraphim_sih_projectile_06_emit.bp',
    ModEmtBpPath .. 'seraphim_sih_projectile_07_emit.bp',
    ModEmtBpPath .. 'seraphim_sih_projectile_08_emit.bp',
    ModEmtBpPath .. 'seraphim_sih_projectile_09_emit.bp',
}

TFlakHit = {
    ModEmtBpPath .. 'ig_aa_autocannon_hit_01_emit.bp',
    ModEmtBpPath .. 'ig_aa_autocannon_hit_02_emit.bp',
    ModEmtBpPath .. 'ig_aa_autocannon_hit_03_emit.bp',
    ModEmtBpPath .. 'ig_aa_autocannon_hit_04_emit.bp',
    ModEmtBpPath .. 'ig_aa_autocannon_hit_05_emit.bp',
    ModEmtBpPath .. 'ig_aa_autocannon_hit_06_emit.bp',
}
CElectronBurstCloud02 = {
    ModEmtBpPath .. 'electron_burst_cloud_gas_01_emit.bp',
    ModEmtBpPath .. 'electron_burst_cloud_sparks_01_emit.bp',
    ModEmtBpPath .. 'electron_burst_cloud_sparks_02_emit.bp',
    ModEmtBpPath .. 'electron_burst_cloud_flash_01_emit.bp',
}

ATemporalFizzHit02 = {
	  ModEmtBpPath .. 'temporal_fizz_01_emit.bp',
    ModEmtBpPath .. 'temporal_fizz_02_emit.bp',
    ModEmtBpPath .. 'temporal_fizz_hit_flash_01_emit.bp',
}
SOlarisCannonHit = {
	EmtBpPath .. 'seraphim_polarix_cannon_projectile_hit_01_emit.bp',
	EmtBpPath .. 'seraphim_polarix_cannon_projectile_hit_02_emit.bp',
	...
	EmtBpPath .. 'seraphim_polarix_cannon_projectile_hit_04_emit.bp',
	EmtBpPath .. 'seraphim_polarix_cannon_projectile_hit_05_emit.bp',
  ModEmtBpPath .. 'seraphim_polarix_cannon_projectile_hit_06_emit.bp',
}
TLaserPhalanxGunMuzzleFlash = {
    ModEmtBpPath .. 'phalanx_muzzle_flash_01_emit.bp',
    ModEmtBpPath .. 'phalanx_muzzle_glow_01_emit.bp',
}
CProtonCannonPolyTrail03 =  { ModEmtBpPath .. 'proton_cannon_polytrail_03_emit.bp' }
CProtonCannonFXTrail03 =  { 
  ModEmtBpPath .. 'proton_cannon_fxtrail_03_emit.bp',
  ModEmtBpPath .. 'proton_cannon_fxtrail_04_emit.bp',
  ModEmtBpPath .. 'proton_cannon_fxtrail_05_emit.bp',  
}
CProtonCannonHit02 = {
     ModEmtBpPath .. 'proton_cannon_hit_01_emit.bp',
     ModEmtBpPath .. 'proton_cannon_hit_02_emit.bp',
     ModEmtBpPath .. 'proton_cannon_hit_03_emit.bp',
     ModEmtBpPath .. 'proton_cannon_hit_04_emit.bp',
     ModEmtBpPath .. 'proton_cannon_hit_05_emit.bp',
     ModEmtBpPath .. 'proton_cannon_hit_06_emit.bp',
}
ZappLaser01 =  { 
  ModEmtBpPath .. 'zapplaser_fxtrail_01_emit.bp',
  ModEmtBpPath .. 'zapplaser_fxtrail_02_emit.bp',
  #ModEmtBpPath .. 'zapplaser_fxtrail_03_emit.bp',  
}
SUltraChromaticBeamGeneratorBeam02 = {
	ModEmtBpPath .. 'seraphim_chromatic_beam_generator_beam_02_emit.bp',
}
SUltraChromaticBeamGeneratorMuzzle02 = 
{
    ModEmtBpPath .. 'seraphim_chromatic_beam_generator_muzzle_03_emit.bp',
    ModEmtBpPath .. 'seraphim_chromatic_beam_generator_muzzle_04_emit.bp',
    ModEmtBpPath .. 'seraphim_chromatic_beam_generator_muzzle_05_emit.bp',
    ModEmtBpPath .. 'seraphim_chromatic_beam_generator_muzzle_06_emit.bp',
}
SChargeUltraChromaticBeamGenerator02 = 
{
    ModEmtBpPath .. 'seraphim_chromatic_beam_generator_muzzle_01_emit.bp',
    ModEmtBpPath .. 'seraphim_chromatic_beam_generator_muzzle_02_emit.bp', 
}
SUltraChromaticBeamGeneratorHitLand02 = {
    ModEmtBpPath .. 'seraphim_chromatic_beam_generator_hit_01_emit.bp',
    ModEmtBpPath .. 'seraphim_chromatic_beam_generator_hit_02_emit.bp',
    ModEmtBpPath .. 'seraphim_chromatic_beam_generator_hit_03_emit.bp',
    ModEmtBpPath .. 'seraphim_chromatic_beam_generator_hit_05_emit.bp',
}